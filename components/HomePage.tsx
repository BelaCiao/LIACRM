        ...
        <div className="overflow-x-hidden animate-fade-in">
            ...
            <section className={`${sectionBaseClasses} min-h-[70vh] flex flex-col justify-center text-center`}>
                ...
                <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
                    <button onClick={onStartQuiz} className="w-full sm:w-auto bg-primary text-white px-8 py-4 rounded-lg text-lg font-semibold hover:bg-blue-600 transition-all transform hover:scale-105 shadow-2xl shadow-blue-500/30">
            ...
            <section ref={ctaRef} id="cta" className={`${sectionBaseClasses} transition-opacity duration-1000 ${isCtaVisible ? 'opacity-100' : 'opacity-0 translate-y-8'}`}>
                <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl max-w-6xl mx-auto p-12 sm:p-16 text-center">
                    ...
                    <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
                         <button onClick={onStartQuiz} className="w-full sm:w-auto bg-primary text-white px-8 py-4 rounded-lg text-lg font-semibold hover:bg-blue-600 transition-transform transform hover:scale-105 shadow-2xl shadow-blue-500/30">
                            Iniciar Diagnóstico Gratuito
                        </button>
                        <a 
                            href="https://wa.me/555399640159" 
